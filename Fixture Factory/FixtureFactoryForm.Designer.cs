...
{
	partial class FixtureFactoryForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.LeaguesDataGridView = new System.Windows.Forms.DataGridView();
			this.LeagueIDColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.LeagueNameColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.LeagueGameTimesDataGridView = new System.Windows.Forms.DataGridView();
			this.SessionIDColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.GameDOWColumn = new System.Windows.Forms.DataGridViewComboBoxColumn();
			...
			this.SeasonTitleTextBox = new System.Windows.Forms.TextBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.LeagueGameTimesDataGridView)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.SeasonPlayingFieldsDataGridView)).BeginInit();
			this.LeagueDetailsGroupBox.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.LeagueNonPlayingDatesDataGridView)).BeginInit();
			...
			this.TeamsDataGridView.Size = new System.Drawing.Size(240, 157);
			...
			// TeamIDColumn
			// 
			this.TeamIDColumn.DataPropertyName = "ID";
			this.TeamIDColumn.HeaderText = "ID";
			this.TeamIDColumn.Name = "TeamIDColumn";
			this.TeamIDColumn.Visible = false;
			// 
			// TeamNameColumn
			// 
			...
			this.TeamNameColumn.HeaderText = "Team Name";
			...
			this.TeamNameLabel.Location = new System.Drawing.Point(6, 19);
			...
			// TeamNameTextBox
			// 
			this.TeamNameTextBox.Location = new System.Drawing.Point(77, 16);
			this.TeamNameTextBox.Name = "TeamNameTextBox";
			this.TeamNameTextBox.ReadOnly = true;
			this.TeamNameTextBox.Size = new System.Drawing.Size(157, 20);
			this.TeamNameTextBox.TabIndex = 1;
			// 
			// LeaguesDataGridView
			// 
			this.LeaguesDataGridView.BackgroundColor = System.Drawing.SystemColors.Window;
			this.LeaguesDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			...
			this.LeaguesDataGridView.Size = new System.Drawing.Size(240, 198);
			...
			// LeagueIDColumn
			// 
			this.LeagueIDColumn.DataPropertyName = "ID";
			this.LeagueIDColumn.HeaderText = "ID";
			this.LeagueIDColumn.Name = "LeagueIDColumn";
			this.LeagueIDColumn.Visible = false;
			// 
			// LeagueNameColumn
			// 
			this.LeagueNameColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			this.LeagueNameColumn.DataPropertyName = "LeagueName";
			this.LeagueNameColumn.HeaderText = "League Name";
			this.LeagueNameColumn.Name = "LeagueNameColumn";
			// 
			// LeagueGameTimesDataGridView
			// 
			this.LeagueGameTimesDataGridView.BackgroundColor = System.Drawing.SystemColors.Window;
			this.LeagueGameTimesDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.LeagueGameTimesDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.SessionIDColumn,
            this.GameDOWColumn,
            this.StartTimeColumn,
            this.GameTimePriorityColumn});
			this.LeagueGameTimesDataGridView.Location = new System.Drawing.Point(12, 60);
			this.LeagueGameTimesDataGridView.Name = "LeagueGameTimesDataGridView";
			this.LeagueGameTimesDataGridView.RowHeadersWidth = 30;
			this.LeagueGameTimesDataGridView.Size = new System.Drawing.Size(223, 148);
			...
			// SessionIDColumn
			// 
			this.SessionIDColumn.DataPropertyName = "ID";
			...
			// GameDOWColumn
			// 
			this.GameDOWColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			this.GameDOWColumn.DataPropertyName = "DayOfWeek";
			this.GameDOWColumn.HeaderText = "Day Of Week";
			this.GameDOWColumn.Items.AddRange(new object[] {
            "Thursday",
            "Friday",
            "Saturday",
            "Sunday",
            ...
            "Tuesday",
            "Wednesday"});
			this.GameDOWColumn.Name = "GameDOWColumn";
			// 
			// StartTimeColumn
			// 
			...
			// 
			// GameTimePriorityColumn
			// 
			this.GameTimePriorityColumn.DataPropertyName = "Priority";
			this.GameTimePriorityColumn.HeaderText = "Priority";
			this.GameTimePriorityColumn.Name = "GameTimePriorityColumn";
			this.GameTimePriorityColumn.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.NotSortable;
			this.GameTimePriorityColumn.Width = 45;
			// 
			// SeasonPlayingFieldsDataGridView
			// 
			this.SeasonPlayingFieldsDataGridView.BackgroundColor = System.Drawing.SystemColors.Window;
			this.SeasonPlayingFieldsDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.SeasonPlayingFieldsDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
			...
			this.SeasonEndDateTimePicker.Leave += new System.EventHandler(this.SeasonEndDateTimePicker_Leave);
			// 
			// SeasonStartDateTimePicker
			// 
			...
			this.SeasonStartDateTimePicker.Leave += new System.EventHandler(this.SeasonStartDateTimePicker_Leave);
			// 
			// label3
			// 
			...
			this.label5.Text = "Available Playing Fields";
			// 
			// label6
			// 
			...
			this.label6.Text = "Stadium Non-Playing Dates";
			// 
			// label7
			// 
			...
			this.LeagueDetailsGroupBox.Controls.Add(this.GameDurationTextBox);
			this.LeagueDetailsGroupBox.Controls.Add(this.label9);
			...
			this.label15.Text = "League Non-Playing Dates";
			// 
			// LeagueNonPlayingDatesDataGridView
			// 
			this.LeagueNonPlayingDatesDataGridView.BackgroundColor = System.Drawing.SystemColors.Window;
			this.LeagueNonPlayingDatesDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			...
			this.LeaguePlayingFieldsCheckedListBox.IntegralHeight = false;
			this.LeaguePlayingFieldsCheckedListBox.Location = new System.Drawing.Point(244, 60);
			this.LeaguePlayingFieldsCheckedListBox.Name = "LeaguePlayingFieldsCheckedListBox";
			this.LeaguePlayingFieldsCheckedListBox.Size = new System.Drawing.Size(114, 148);
			this.LeaguePlayingFieldsCheckedListBox.TabIndex = 18;
			this.LeaguePlayingFieldsCheckedListBox.ItemCheck += new System.Windows.Forms.ItemCheckEventHandler(this.LeaguePlayingFieldsCheckedListBox_ItemCheck);
			// 
			// label11
			// 
			this.label11.AutoSize = true;
			this.label11.Location = new System.Drawing.Point(241, 44);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(117, 13);
			this.label11.TabIndex = 16;
			this.label11.Text = "Available Playing Fields";
			// 
			// label10
			// 
			...
			this.GameDurationTextBox.Leave += new System.EventHandler(this.GameDurationTextBox_Leave);
			// 
			// label9
			// 
			...
			this.label9.Text = "Game Duration (mins)";
			// 
			// LeagueNameTextBox
			// 
			this.LeagueNameTextBox.Location = new System.Drawing.Point(86, 18);
			this.LeagueNameTextBox.Name = "LeagueNameTextBox";
			this.LeagueNameTextBox.ReadOnly = true;
			this.LeagueNameTextBox.Size = new System.Drawing.Size(149, 20);
			this.LeagueNameTextBox.TabIndex = 12;
			// 
			// label8
			// 
			...
			this.TeamDetailsGroupBox.Controls.Add(this.label13);
			this.TeamDetailsGroupBox.Controls.Add(this.TeamLeagueTextBox);
			...
			this.label16.Text = "Team Non-Playing Dates";
			// 
			// TeamNonPlayingDatesDataGridView
			// 
			this.TeamNonPlayingDatesDataGridView.BackgroundColor = System.Drawing.SystemColors.Window;
			this.TeamNonPlayingDatesDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			...
			this.PairedTeamsCheckedListBox.IntegralHeight = false;
			this.PairedTeamsCheckedListBox.Location = new System.Drawing.Point(11, 55);
			this.PairedTeamsCheckedListBox.Name = "PairedTeamsCheckedListBox";
			this.PairedTeamsCheckedListBox.Size = new System.Drawing.Size(148, 114);
			this.PairedTeamsCheckedListBox.TabIndex = 20;
			this.PairedTeamsCheckedListBox.ItemCheck += new System.Windows.Forms.ItemCheckEventHandler(this.PairedTeamsCheckedListBox_ItemCheck);
			// 
			// label13
			// 
			...
			this.label13.Text = "Paired Team(s)";
			// 
			// TeamLeagueTextBox
			// 
			this.TeamLeagueTextBox.Location = new System.Drawing.Point(289, 16);
			this.TeamLeagueTextBox.Name = "TeamLeagueTextBox";
			this.TeamLeagueTextBox.ReadOnly = true;
			this.TeamLeagueTextBox.Size = new System.Drawing.Size(157, 20);
			this.TeamLeagueTextBox.TabIndex = 8;
			// 
			...
			// 
			this.dataGridViewTextBoxColumn4.DataPropertyName = "SeasonID";
			this.dataGridViewTextBoxColumn4.HeaderText = "SeasonID";
			...
			this.dataGridViewTextBoxColumn5.DataPropertyName = "LeagueName";
			this.dataGridViewTextBoxColumn5.HeaderText = "League Name";
			...
			this.dataGridViewTextBoxColumn7.HeaderText = "Team Name";
			...
			this.timeColumn1.DefaultCellStyle = dataGridViewCellStyle4;
			this.timeColumn1.HeaderText = "Start Time";
			this.timeColumn1.Name = "timeColumn1";
			this.timeColumn1.Width = 50;
			// 
			...
			// 
			this.GenerateFixturesButton.Location = new System.Drawing.Point(1033, 428);
			this.GenerateFixturesButton.Name = "GenerateFixturesButton";
			this.GenerateFixturesButton.Size = new System.Drawing.Size(123, 23);
			this.GenerateFixturesButton.TabIndex = 18;
			this.GenerateFixturesButton.Text = "Generate Fixtures";
            ...
            this.OtherFixtureTechBenchTeamColumn});
			...
			this.OtherFixturesDataGridView.Size = new System.Drawing.Size(673, 251);
			...
			this.EvenRoundsOnlyCheckBox.Location = new System.Drawing.Point(1033, 486);
			...
			this.Text = "Fixture Factory";
			this.Load += new System.EventHandler(this.FixtureFactoryForm_Load);
			this.Shown += new System.EventHandler(this.FixtureFactoryForm_Shown);
			this.FixtureMenuStrip.ResumeLayout(false);
			this.FixtureMenuStrip.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.TeamsDataGridView)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.LeaguesDataGridView)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.LeagueGameTimesDataGridView)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.SeasonPlayingFieldsDataGridView)).EndInit();
			this.LeagueDetailsGroupBox.ResumeLayout(false);
			this.LeagueDetailsGroupBox.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.LeagueNonPlayingDatesDataGridView)).EndInit();
		...
		private System.Windows.Forms.MenuStrip FixtureMenuStrip;
		private System.Windows.Forms.ToolStripMenuItem fileToolStripMenuItem;
		private System.Windows.Forms.ToolStripMenuItem exitToolStripMenuItem;
		private System.Windows.Forms.DataGridView LeaguesDataGridView;
		private System.Windows.Forms.DataGridView TeamsDataGridView;
		private System.Windows.Forms.Label TeamNameLabel;
		private System.Windows.Forms.TextBox TeamNameTextBox;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.DataGridView LeagueGameTimesDataGridView;
		private System.Windows.Forms.DataGridView SeasonPlayingFieldsDataGridView;
		private System.Windows.Forms.DataGridView SeasonNonPlayingDatesDataGridView;
		private System.Windows.Forms.DateTimePicker SeasonEndDateTimePicker;
		private System.Windows.Forms.DateTimePicker SeasonStartDateTimePicker;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.TextBox SeasonTitleTextBox;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.Label label7;
		private System.Windows.Forms.GroupBox LeagueDetailsGroupBox;
		...
		private System.Windows.Forms.CheckedListBox LeaguePlayingFieldsCheckedListBox;
		private System.Windows.Forms.DataGridViewTextBoxColumn TeamIDColumn;
		private System.Windows.Forms.DataGridViewTextBoxColumn TeamNameColumn;
		private System.Windows.Forms.DataGridViewTextBoxColumn LeagueIDColumn;
		private System.Windows.Forms.DataGridViewTextBoxColumn LeagueNameColumn;
		...
		private System.Windows.Forms.DataGridView TeamNonPlayingDatesDataGridView;
		private System.Windows.Forms.DataGridViewTextBoxColumn SessionIDColumn;
		private System.Windows.Forms.DataGridViewComboBoxColumn GameDOWColumn;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn OtherFixtureTechBenchTeamColumn;
	}
}
